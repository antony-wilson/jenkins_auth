...
function IdPSelectUIParms(){
    ...
    this.defaultLogo = '/sesc/static/jenkins_auth/images/stfc.png';  // Replace with your own logo
    this.defaultLogoWidth = 1;
    this.defaultLogoHeight = 1 ;
                                     // If non null, then the default place to send users who are not
                                     // Approaching via the Discovery Protocol for example
    this.defaultReturn = "https://build-test.softeng-support.ac.uk/Shibboleth.sso/Login?SAMLDS=1&target=https://build-test.softeng-support.ac.uk/sesc/accounts/shib/";
